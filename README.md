...
```text
/oem/printer_data/config/filament_inventory/index.html
/oem/printer_data/config/filament_inventory/openrfid_inventory_bridge_hybrid_uid_only.py
/oem/printer_data/config/filament_inventory/inventory_deduction_daemon_with_log
...
```bash
cp index.html /oem/printer_data/config/filament_inventory/index.html
```

Set permissions:

```bash
chmod -R 755 /oem/printer_data/config/filament_inventory
chmod 755 /oem/printer_data/
chmod 755 oem/printer_data/config
```
...
```text
/oem/printer_data/config/filament_inventory/
```
